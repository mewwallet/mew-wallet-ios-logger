...
public extension Logger {
  static func trace(_ system: Logger.System, _ error: (any Error)?, metadata: Logger.Metadata? = nil) {
#if DEBUG
  ...
  static func debug(_ system: Logger.System, _ error: (any Error)?, metadata: Logger.Metadata? = nil) {
#if DEBUG
  ...
  static func info(_ system: Logger.System, _ error: (any Error)?, metadata: Logger.Metadata? = nil) {
#if DEBUG
  ...
  static func notice(_ system: Logger.System, _ error: (any Error)?, metadata: Logger.Metadata? = nil) {
#if DEBUG
  ...
  static func warning(_ system: Logger.System, _ error: (any Error)?, metadata: Logger.Metadata? = nil) {
    guard system.level <= .warning else { return }
    Logger.for(system).warning(error: error, metadata: metadata)
  }
  
  static func error(_ system: Logger.System, _ error: (any Error)?, metadata: Logger.Metadata? = nil) {
    guard system.level <= .error else { return }
    Logger.for(system).error(error: error, metadata: metadata)
  }
  
  static func critical(_ system: Logger.System, _ error: (any Error)?, metadata: Logger.Metadata? = nil) {
